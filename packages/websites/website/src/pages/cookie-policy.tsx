...
const CookiePolicyPage: FC = () => (
  <Layout pageTitle="Terms of Service">
    <Section styleType="layered">
      <Content>
        <Title size="lg" copy="Cookie Policy" />
        <p>
          We use cookies to help improve your experience of{" "}
          <a href="http://heatherturanocoaching.com">
            http://heatherturanocoaching.com
          </a>
          . This cookie policy is part of Heather Turano Coaching, LLC&apos;s
          privacy policy, and covers the use of cookies between your device and
          our site. We also provide basic information on third-party services we
          may use, who may also use cookies as part of their service, though
        ...
        <h1>Types of cookies and how we use them</h1>
        ...
        <h1>Third-party cookies on our site</h1>
        <p>
          ...
          they are not covered by Heather Turano Coaching, LLC&apos;s cookie
          policy.
        </p>
        <h2>Our third-party privacy promise</h2>
        <p>
        ...
        <h1>How you can control or opt out of cookies</h1>
        <p>

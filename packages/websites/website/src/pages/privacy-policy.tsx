...
const PrivacyPolicyPage: FC = () => (
  <Layout pageTitle="Terms of Service">
    <Section styleType="layered">
      <Content>
        <Title size="lg" copy="Privacy Policy" />
        <p>
          Your privacy is important to us. It is Heather Turano Coaching,
          LLC&apos;s policy to respect your privacy regarding any information we
        ...
        <h1>2. Legal bases for processing</h1>
        <p>
        ...
        <h1>3. Collection and use of information</h1>
        <p>
        ...
        <h1>4. Disclosure of personal information to third parties</h1>
        ...
        <h1>5. International transfers of personal information</h1>
        <p>
        ...
        <h1>6. Your rights and controlling your personal information</h1>
        <p>
        ...
        <p>
          <strong>Heather Turano Coaching, LLC Data Controller</strong>
          <br />
          Heather Turano
          <br />
          me@heatherturanocoaching.com
        </p>
        <p>This policy is effective as of 27 April 2019.</p>
      </Content>
    </Section>
  </Layout>
);

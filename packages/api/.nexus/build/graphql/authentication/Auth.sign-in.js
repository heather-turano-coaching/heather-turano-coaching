            ...
            resolve(_root, args, context) {
                return tslib_1.__awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        if (!user) {
                            throw Auth_utils_1.genericAuthError;
                        }
                        ...
                        yield Auth_utils_1.matchHashedPasswords(args.password, user.password);
                        const jwt = yield Auth_utils_1.getJsonWebToken({
...
//# sourceMappingURL=Auth.sign-in.js.map
            ...
            resolve(_root, args, context) {
                return tslib_1.__awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        yield Auth_utils_1.validatePasswords(args.password, args.repeatPassword);
                        const hashedPassword = yield Auth_utils_1.hashAndSaltUsersPassword(args.password);
                        const confirmationKey = yield Auth_utils_1.getEmailToken({
                        ...
                        yield Auth_email_1.sendConfirmAccountEmail({
...
//# sourceMappingURL=Auth.sign-up.js.map